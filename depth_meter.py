...
class DepthMeter(Widget): #สร้างคลาส DepthMeter ที่สืบทอดมาจากคลาส Widget
    ...
    def update_meter(self, *args): #สร้างเมธอด update_meter ที่รับค่าพารามิเตอร์ args คือรับค่าหลายๆค่าโดยไม่ต้องกำหนดตัวแปรๆไว้ล่วงหน้า
        ...
        with self.canvas: #กำหนดการวาดรูปภาพ
            # Background
            Color(0.4, 0.4, 0.4) #กำหนดสีเป็นสีเทา
            Rectangle(pos=self.pos, size=self.size) #วาดสี่เหลี่ยมขนาดเท่ากับขนาดของวิดเจต
            
            # Depth indicator
            Color(0, 0.75, 1) #กำหนดสีเป็นสีน้ำเงินฟ้า
            height = (self.depth / 700) * self.height #คำนวณความสูงของระดับน้ำ เพื่อปรับขนาดให้สัมพันธ์กับความลึก
            Rectangle(pos=self.pos, size=(self.width, height)) #วาดสี่เหลี่ยมขนาดเท่ากับความสูงของระดับน้ำ
